...
def main():
    # 配置PID控制器
    pid = PIDController(kp=15.0, ki=4, kd=10.0, set_point=100, u_f_min=0, u_f_max=100)
...
#         # 绘制目标高度基准线
#         axs[0].axhline(y=30, color='r', linestyle='--', label='Target Height (10m)')
#         axs[0].set_xlabel('Time')
...
# def main():
#     # 配置PID控制器
#     pid = PIDController(kp=15.0, ki=13.0, kd=10.0, set_point=30, u_f_min=0.0, u_f_max=100)  # 推力范围[0, 20]
